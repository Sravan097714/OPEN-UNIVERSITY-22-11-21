page 50027 "Module Card"
{
        ...
        area(content)
        {
            group(Item)
            {
                ...
                field("No."; "No.")
                {
                    ...
                    begin
                        InvtSetup.get;
                        InvtSetup.TestField(InvtSetup."Module No. Series");
                        if NoSeriesMgt.SelectSeries(InvtSetup."Module No. Series", xRec."No. Series", "No. Series") then begin
            ...
            group("Module Information")
            {
                ...
                field(Credit; Credit) { ApplicationArea = All; }
    ...
    begin
        ...
        "Gen. Prod. Posting Group" := 'MODULE';
        "VAT Prod. Posting Group" := 'VAT';
        //"Inventory Posting Group" := 'MODULE';
    end;
