    ...
    layout
    {
        area(Content)
        {
            repeater("Module Fees")
            {
                ...
                field("Module ID 2"; "Module ID 1") { ApplicationArea = all; }
                ...
                field("Module ID 3"; "Module ID 1") { ApplicationArea = all; }
                ...
                field("Module ID 4"; "Module ID 1") { ApplicationArea = all; }
                ...
                field("Module ID 5"; "Module ID 1") { ApplicationArea = all; }
                ...
                field("Module ID 6"; "Module ID 1") { ApplicationArea = all; }
