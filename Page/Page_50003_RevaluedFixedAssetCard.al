page 50003 "Revalued Fixed Asset Card"
{
    Caption = 'Revalued Fixed Asset Card';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field(Warranty; Warranty) { ApplicationArea = All; }
                field("Warranty Description"; "Warranty Description") { ApplicationArea = All; }
