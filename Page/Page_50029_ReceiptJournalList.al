page 50029 "Receipt Journal List"
{
    DataCaptionExpression = DataCaption;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Navigate';
    SourceTable = "Gen. Journal Batch";
    SourceTableView = where("Journal Template Name" = filter('CASH RECE'));
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    begin
        ...
        if gtextfilter <> '' then begin
            Rec.SetRange("Journal Template Name", 'CASH RECE');
            Rec.SetFilter(Name, gtextfilter);
        end else
