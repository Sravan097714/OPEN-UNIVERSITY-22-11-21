page 50023 "Payment Journal for Suppliers"
{
        ...
        area(content)
        {
            field(CurrentJnlBatchName; CurrentJnlBatchName)
            {
                ...
                begin
                    ...
                    Commit();
                    GenJnlBatch."Journal Template Name" := Rec."Journal Template Name";
                    GenJnlBatch.Name := Rec."Journal Batch Name";
                    GenJnlBatch.FilterGroup(2);
                    GenJnlBatch.SetRange("Journal Template Name", GenJnlBatch."Journal Template Name");
                    GenJnlBatch.FilterGroup(0);
                    if PAGE.RunModal(50025, GenJnlBatch) = ACTION::LookupOK then begin
                        CurrentJnlBatchName := GenJnlBatch.Name;
                        GenJnlMgt.SetName(CurrentJnlBatchName, Rec);
                    end;
            ...
            repeater(Control1)
            {
                ...
                field("Account No."; "Account No.")
                {
                    ...
                    var
                        ...
                        gpageCustomer: Page "Customer List";

                        grecFixedAsset: Record "Fixed Asset";
                        gpageFixedAsset: Page "Fixed Asset List";

                        grecEmployee: Record Employee;
                        gpageEmployee: Page "Employee List";

                        grecICPartner: Record "IC Partner";
                        gpageICPartner: Page "IC Partner List";

                        grecBankAccount: Record "Bank Account";
                        gpageBankAccount: Page "Bank Account List";
                    ...
                    begin
                        case "Account Type" of
                                ...
                                begin
                                    ...
                                    if grecVendor.FindFirst() then begin
                                        ...
                                        if gpageVendorList.RunModal() = Action::LookupOK then begin
                                            ...
                                            Rec.Validate("Account No.", grecVendor."No.");
                                        end;
                                    end;
                                end;
                            ...
                            "Account Type"::Customer:
                                begin
                                    ...
                                    if grecCustomer.FindFirst() then begin
                                        gpageCustomer.SetRecord(grecCustomer);
                                        gpageCustomer.SetTableView(grecCustomer);
                                        gpageCustomer.LookupMode(true);
                                        if gpageCustomer.RunModal() = Action::LookupOK then begin
                                            gpageCustomer.GetRecord(grecCustomer);
                                            Rec.Validate("Account No.", grecCustomer."No.");
                                        end;
                                    end;
                                end;
                            "Account Type"::"Bank Account":
                                begin
                                    ...
                                    if grecBankAccount.FindFirst() then begin
                                        gpageBankAccount.SetRecord(grecBankAccount);
                                        gpageBankAccount.SetTableView(grecBankAccount);
                                        gpageBankAccount.LookupMode(true);
                                        if gpageBankAccount.RunModal() = Action::LookupOK then begin
                                            gpageBankAccount.GetRecord(grecBankAccount);
                                            Rec.Validate("Account No.", grecBankAccount."No.");
                                        end;
                                    end;
                                end;
                                ...
                                begin
                                    ...
                                    if grecGLAccount.FindFirst() then begin
                                        ...
                                        if gpageGLAccount.RunModal() = Action::LookupOK then begin
                                            ...
                                            Rec.Validate("Account No.", grecGLAccount."No.");
                                        end;
                                    end;
                                end;
                                ...
                                begin
                                    ...
                                    if grecFixedAsset.FindFirst() then begin
                                        ...
                                        if gpageFixedAsset.RunModal() = Action::LookupOK then begin
                                            ...
                                            Rec.Validate("Account No.", grecFixedAsset."No.");
                                        end;
                                    end;
                                end;
                            ...
                            "Account Type"::"IC Partner":
                                begin
                                    grecICPartner.Reset();
                                    grecICPartner.SetRange(Code);
                                    if grecICPartner.FindFirst() then begin
                                        gpageICPartner.SetRecord(grecICPartner);
                                        gpageICPartner.SetTableView(grecICPartner);
                                        gpageICPartner.LookupMode(true);
                                        if gpageICPartner.RunModal() = Action::LookupOK then begin
                                            gpageICPartner.GetRecord(grecICPartner);
                                            Rec.Validate("Account No.", grecICPartner.Code);
                                        end;
                                    end;
                                end;
                            ...
                            "Account Type"::Employee:
                                begin
                                    grecEmployee.Reset();
                                    grecEmployee.SetRange("No.");
                                    if grecEmployee.FindFirst() then begin
                                        gpageEmployee.SetRecord(grecEmployee);
                                        gpageEmployee.SetTableView(grecEmployee);
                                        gpageEmployee.LookupMode(true);
                                        if gpageEmployee.RunModal() = Action::LookupOK then begin
                                            gpageEmployee.GetRecord(grecEmployee);
                                            Rec.Validate("Account No.", grecEmployee."No.");
                                        end;
                                    end;
                                end;
                        end;
        ...
        area(navigation)
        {
            ...
            group("&Payments")
            {
                ...
                action(SuggestVendorPayments)
                {
                    ...
                    trigger OnAction()
                    var
                        SuggestVendorPayments: Report "Suggt. Vendor Pymt UserWise"; //SRAVAN 20211011
                    begin
                ...
                action("Void &All Checks")
                {
                    ...
                    begin
                        ...
                        if grecUserSetup.Get(UserId) then begin
                            if not grecUserSetup."Void All Checks" then
                                Error(gtextErrorAccess);
                        end else
                            Error(gtextErrorAccess);
    ...
    var
        ...
        gpageGenJnlBatch: Page "General Journal Batches";
    begin
