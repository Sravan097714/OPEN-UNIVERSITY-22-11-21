page 50039 "Issued R. List Course Fees"
{
    ApplicationArea = Suite;
    Caption = 'Issued Reminder List for Course Fees';
    CardPageID = "Issued Reminder Course Fees";
    DataCaptionFields = "Customer No.";
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    SourceTable = "Issued Reminder Header";
    SourceTableView = where("Course Reminder" = filter(true));
    UsageCategory = Lists;
