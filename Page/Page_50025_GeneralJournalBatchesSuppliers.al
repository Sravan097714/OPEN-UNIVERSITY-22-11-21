page 50025 "General Jnl Batches Suppliers"
{
    Caption = 'Payment Journal Batches for Suppliers';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("PV No. Series"; "PV No. Series") { ApplicationArea = All; }
        ...
        area(processing)
        {
            action(EditJournal)
            {
                ...
                begin
                    ...
                    GenJnlLine."Journal Batch Name" := Rec.Name;
                    PAGE.Run(50023, GenJnlLine);
                end;
            }
            group("P&osting")
            {
    ...
    begin
        ...
        grecUserforCashRcptJnl.Setfilter("Jnl Template Name", '%1|%2', 'PAYMENT', 'PAYMENTS');
