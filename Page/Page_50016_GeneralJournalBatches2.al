page 50016 "General Journal Batches 2"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("PV No. Series"; "PV No. Series")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the PV number series that will be used to assign document numbers to ledger entries that are posted from this journal batch.';
                }
