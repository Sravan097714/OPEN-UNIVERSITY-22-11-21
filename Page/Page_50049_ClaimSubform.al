                ...
                /* field("G/L Account for Budget"; "G/L Account for Budget")
                {
                    ...
                    begin
                        ...
                        if grecGLAccount.FindFirst() then begin
                            ...
                            if gpageGLAccount.RunModal() = Action::LookupOK then begin
                                gpageGLAccount.GetRecord(grecGLAccount);
                                if grecGLAccount.Get("No.") then begin
                                    Rec."G/L Account for Budget" := grecGLAccount."No.";
                                    Rec."Account Category" := grecGLAccount."Account Category";
                                end;
                            end;
                        end;
                    end;
                ...
                group("F&unctions")
                {
                    ...
                    action("Calculate PAYE")
                    {
                        ...
                        var
                            ...
                            grecPurchLine2: Record "Purchase Line";
                            grecNewCategories: Record "New Categories";
                            grecPurchaseAndPayables: Record "Purchases & Payables Setup";
                            grecGeneralLedgerSetup: Record "General Ledger Setup";

                        begin
                            grecGeneralLedgerSetup.Get();
                            grecPurchaseAndPayables.Get();
                            grecPurchLine.Reset();
                            grecPurchLine.SetRange("Document No.", "Document No.");
                            grecPurchLine.SetRange("Document Type", "Document Type");
                            grecPurchLine.SetRange("System-Created Entry", false);
                            ...
                            if grecPurchLine.FindFirst() then begin
                                repeat
                                    ...
                                    if grecPurchLine.VAT then
                                        grecPurchLine2.validate("Direct Unit Cost", ROUND((grecGeneralLedgerSetup."VAT %" * grecPurchLine."Line Amount Excluding VAT"), 1, '='))
                                    else
                    ...
                    /* action("Get Earmarked Amount")
                    {
                        ...
                        begin
                            ...
                            if Page.RunModal(50061, grecEarmarkingClaim) = Action::LookupOK then begin
                                ...
                                grecPurchaseLine.SetRange("Document No.", "Document No.");
