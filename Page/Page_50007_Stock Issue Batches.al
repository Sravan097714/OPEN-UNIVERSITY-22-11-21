page 50007 "Stock Issue Batches"
{
    Caption = 'Store Issue Batches';
    DataCaptionExpression = DataCaption;
    PageType = List;
    SourceTable = 233;
    SourceTableView = where("Journal Template Name" = filter('ITEM'), "Positive Item Batch" = filter(false));
    ApplicationArea = All;
    UsageCategory = Lists;
