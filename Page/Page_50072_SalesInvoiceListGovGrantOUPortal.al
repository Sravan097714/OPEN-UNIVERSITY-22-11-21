page 50072 "Sale Inv Gov Grant OU List"
{
    ApplicationArea = All;
    Caption = 'Sales Invoice List Gov Grant OU Portal';
    CardPageID = "Sales Invoice OU Portal";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Invoice), "From OU Portal" = filter(TRUE), "Gov Grant" = filter(true));
    UsageCategory = Lists;
