report 50065 "Calculate Inventory 2"
{
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            RequestFilterFields = "No.", "Item Category Code", "Product Group Code 2", "Location Filter", "Bin Filter";
            ...
            begin
                if PostingDate = 0D then
                    Error(Text000);
                SetRange(Module, false);//RCTS 10/05/21
