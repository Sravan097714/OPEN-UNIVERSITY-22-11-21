report 50106 "Purchase - Receipt New"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\PurchaseReceipt.rdl';
        ...
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Posting_Date; Format("Purch. Rcpt. Header"."Posting Date", 0, 4))
                    {
                    }
                    column(Order_No; "Purch. Rcpt. Header"."Order No.")
                    {
                    }
