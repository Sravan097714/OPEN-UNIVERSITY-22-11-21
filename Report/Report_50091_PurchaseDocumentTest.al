report 50091 "Purchase Document - Test 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\PurchaseDocumentTest.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Created_By; gtextPreparedBy) { }
            column(grecCompanyInfoName; grecCompanyInfo.Name) { }
            column(grecCompanyInfoAddress; grecCompanyInfo.Address) { }
            column(grecCompanyInfoPhoneNo; grecCompanyInfo."Phone No.") { }
            column(grecCompanyInfoFaxNo; grecCompanyInfo."Fax No.") { }
            ...
            begin
                ...
                clear(gtextPreparedBy);
                grecUser.Reset();
                grecUser.SetRange("User Name", "Created By");
                if grecUser.FindFirst() then
                    gtextPreparedBy := grecUser."Full Name";
            end;
