report 50129 "Cust - Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\CustomerDetailTrialBalance.rdl';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    GLSetup.Get();
                    if DimValues.Get(GLSetup."Global Dimension 1 Code", "Global Dimension 1 Code") then
                    ...
                    if DimValues.Get(GLSetup."Global Dimension 2 Code", "Global Dimension 2 Code") then
    ...
    var
        ...
        PageGroupNo: Integer;
        CustDetailTrialBalCaptionLbl: Label 'Customer - Detailed Trial Balance';
