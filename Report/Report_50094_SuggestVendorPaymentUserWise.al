report 50094 "Suggt. Vendor Pymt UserWise"
{
    Caption = 'Suggest Vendor Payments UserWise';
    ProcessingOnly = true;
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    group("Find Payments")
                    {
                        ...
                        //SRAVAN 20211011 >>
                        field(UserIDFilter; UserIDFilter)
                        {
                            ApplicationArea = all;
                            TableRelation = "User Setup"."User ID";
                            Caption = 'User ID';
                            ToolTip = 'Specifies User to get that particular user vendor payments to suggest.';
                        }
                        //SRAVAN 20211011 <<
                        field(CreatedByFilter; CreatedByFilter)
                        {
                            ApplicationArea = all;
                            TableRelation = "User Setup"."User ID";
                            Caption = 'Created By';
    ...
    begin
        ...
        if UserIDFilter <> '' then
            VendLedgEntry.SetRange("User ID", UserIDFilter);
        //SRAVAN 20211011 <<
