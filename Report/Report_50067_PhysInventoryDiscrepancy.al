report 50067 "Phys. Inventory Discrepancy"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\PhysInventoryListDiscrepancy.rdl';
    ApplicationArea = All;
    Caption = 'Physical Inventory Discrepancy Report';
    ...
    dataset
    {
        dataitem(PageLoop; "Integer")
        {
            ...
            column(ShowQtyCalculated; gboolViewQtyonHand)
            {
            }
            ...
            dataitem("Item Journal Batch"; "Item Journal Batch")
            {
                ...
                dataitem("Item Journal Line"; "Item Journal Line")
                {
                    ...
                    column(gdecTotal1; gdecTotal1) { }
                    column(gdecTotal2; gdecTotal2) { }
                    ...
                    begin
                        ...
                        if "Qty. (Phys. Inventory)" - "Qty. (Calculated)" <> 0 then begin
                            gdecTotal1 += "Qty. (Calculated)";
                            gdecTotal2 += "Qty. (Phys. Inventory)";
                        end;
                    end;
                }
    ...
    trigger OnPreReport()
    begin
        Clear(gboolViewQtyonHand);
        if grecUserSetup.Get(UserId) then begin
            gboolViewQtyonHand := grecUserSetup."View Qty on Hand";
        end;
    ...
    var
        ...
        PhysInventoryListCaptionLbl: Label 'Physical Inventory Discrepancy Report';
