report 50047 "Aged Accounts Receivable CPG"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\Aged Accounts Receivable2.rdl';
    ApplicationArea = All;
    Caption = 'Aged Accounts Receivable by Customer Posting Group';
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "No.";//,"Customer Posting Group"; //RCTS1.0 15/07/19 - Added Customer Posting Group
            ...
            column(gtextCustLedgerEntryFilter; 'Customer Ledger Entry' + ': ' + gtextCustLedgerEntryFilter) { }
            ...
            dataitem(OpenCustLedgEntry; "Cust. Ledger Entry")
            {
                ...
                RequestFilterFields = "Global Dimension 1 Code", "Global Dimension 2 Code", "Customer Posting Group"; //RCTS1.0 15/07/19
                ...
                begin
                    ...
                    //RCTS1.0 27/11/19
                    FilterfromCustomerLedgerEntry := OpenCustLedgEntry.GETVIEW();
                    //RCTS1.0 27/11/19
                end;
            }
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempCustLedgEntryLoop; Integer)
                {
                    DataItemTableView = SORTING(Number)
                                        WHERE(Number = FILTER(1 ..));
                    column(Name1_Cust; Customer.Name + ' ' + Customer."Name 2")
                    {
                        //IncludeCaption = true;
                    }
                    ...
                    column(CustPostingGrp; gtextGrpBy) { }
                    ...
                    begin
                        ...
                        //RCTS1.0 13/04/2020
                        case goptGroupBy of
                            goptGroupBy::"Customer Posting Group":
                                gtextGrpBy := CustLedgEntryEndingDate."Customer Posting Group";

                            goptGroupBy::Programme:
                                gtextGrpBy := CustLedgEntryEndingDate."Global Dimension 1 Code";

                            goptGroupBy::Intake:
                                gtextGrpBy := CustLedgEntryEndingDate."Global Dimension 2 Code";
                        end;
                        //RCTS1.0 13/04/2020
                    ...
                    begin
                        ...
                        //RCTS1.0 22/07/19
                        //TempCustLedgEntry.COPYFILTERS(OpenCustLedgEntry);
                        //RCTS1.0 22/07/19

                        IF FilterfromCustomerLedgerEntry <> '' THEN
                            TempCustLedgEntry.SETVIEW(FilterfromCustomerLedgerEntry);
                        //RCTS1.0 27/11/19
            ...
            begin
                ...
                IF TempCurrencyAmount.FINDSET(FALSE, FALSE) THEN
                    REPEAT
                        ...
                        ELSE
                            AgedCustLedgEntry[8]."Remaining Amount" := TempCurrencyAmount.Amount;//RCTS1.0 - Change array from 6 to 8
    ...
    begin
        ...
        gtextCustLedgerEntryFilter := CaptionManagement.GetRecordFiltersWithCaptions(OpenCustLedgEntry);
    ...
    var
        ...
        AgedCustLedgEntry: array[8] of Record "Cust. Ledger Entry";
        ...
        AgedAccReceivableCptnLbl: Label 'Aged Accounts Receivable by Customer Posting Group';
        ...
        LabelText1: Label 'More than %1 days';
        LabelText2: Label 'days';
        FilterfromCustomerLedgerEntry: Text;
        gtextCustLedgerEntryFilter: Text;
        goptGroupBy: Option "Customer Posting Group","Programme","Intake";
    ...
    begin
        ...
        ELSE
            ...
            HeaderText[i] := STRSUBSTNO(LabelText1, EndingDate - PeriodStartDate[i - 1] + 1);
