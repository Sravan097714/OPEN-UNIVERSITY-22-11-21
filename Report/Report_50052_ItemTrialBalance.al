report 50052 "Item Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\ItemTrialBalance.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            DataItemTableView = SORTING("Inventory Posting Group") WHERE(Type = CONST(Inventory), Module = filter(false));
    ...
    var
        ...
        Inventory_ValuationCaptionLbl: Label 'Item Trial Balance';
