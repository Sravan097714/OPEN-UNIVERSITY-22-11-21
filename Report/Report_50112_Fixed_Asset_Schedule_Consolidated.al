report 50112 "FA Schedule Consolidated"
{
    Caption = 'Fixed Asset Schedule Consolidated';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("FA Schedule Grouping"; "FA Schedule Grouping")
        {
            RequestFilterFields = "Report Type";
            ...
            dataitem("FA Ledger Entry"; "FA Ledger Entry")
            {
                ...
                begin
                    ...
                    SetFilter("FA Posting Group", "FA Schedule Grouping"."FA Posting Filters");
                end;
            }
        }
    }
