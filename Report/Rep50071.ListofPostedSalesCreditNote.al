report 50071 "List of Posted Sales Cr. Note"
{
    ApplicationArea = All;
    Caption = 'List of Posted Sales Credit Note';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\ListofPostedSalesCreditNote.rdl';
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            RequestFilterFields = "No.", "Sell-to Customer No.", "Posting Date", "Pre-Assigned No.", "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code";
