report 50105 "Chart of Accounts_2"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\ChartofAccounts.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            column(Balance_Caption; "G/L Account".FieldCaption(Balance))
            {
            }
            column(Budget_Category_Caption; "G/L Account".FieldCaption("Budget Category"))
            {
            }
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(Balance; "G/L Account".Balance)
                {

                }
                column(Budget_Category; "G/L Account"."Budget Category")
                {
