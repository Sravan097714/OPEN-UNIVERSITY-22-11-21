report 50118 "Copy Fixed Asset 2"
{
                ...
                group(Options)
                {
                    ...
                    field(FirstFANo; FirstFANo)
                    {
                        ...
                        begin
                            ...
                            NoSeriesMgt.SelectSeries(FASetup."Fixed Asset Nos.", '', FirstFANo);
                        end;
                    }
    ...
    begin
        ...
        for I := 1 to NumberofCopies do begin
            ...
            if UseFANoSeries then
                ...
                FA2."No." := NoSeries.GetNextNo(FirstFANo, 0D, true);
                FA2."No. Series" := FirstFANo;
    ...
    var
        ...
        Text001: Label 'You must specify a number in First FA No. field.';
