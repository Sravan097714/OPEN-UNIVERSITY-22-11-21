    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Description_SalesInvoiceLine; COPYSTR("Sales Invoice Line".Description + ' ' + "Sales Invoice Line"."Description 2", 1, 100)) { }
            ...
            begin
                ...
                gtextCurrency := "Sales Invoice Header"."Currency Code";
