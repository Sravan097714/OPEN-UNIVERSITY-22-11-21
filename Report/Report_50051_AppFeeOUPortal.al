report 50051 "Posted App. Fees OU Portal"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\AppFeeOUPortal.rdl';
    Caption = 'Posted Application Fees from OU Portal Report';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("No.") where("Source Code" = filter('CASHRECJNL'));
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                RequestFilterFields = "Document No.", "Posting Date", "User ID", "Source Code";
            ...
            begin
                SetRange("Journal Batch Name", grecSalesReceivableSetup."Journal Batch Name OU Portal");
            end;
        }
    }
    ...
    var
        GLAcc: Record 15;
        GLRegFilter: Text;
        G_L_RegisterCaptionLbl: Label 'Posted Application Fees from OU Portal Report';
