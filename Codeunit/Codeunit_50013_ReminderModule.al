codeunit 50013 "Reminder Module"
{
    ...
    begin
        ...
        with Cust do begin
            ...
            if MakeDoc and (CustAmount > 0) and (CustAmountLCY(CurrencyCode, CustAmount) >= ReminderTerms."Minimum Amount (LCY)") then begin
                    ...
                    if CustLedgEntry.FindSet then begin
                        repeat
                            ...
                            if ReminderDueDate < ReminderHeaderReq."Document Date" then begin
                                ...
                                ReminderHeader."Shortcut Dimension 1 Code" := CustLedgEntry."Global Dimension 1 Code";
                                ReminderHeader."Shortcut Dimension 2 Code" := CustLedgEntry."Global Dimension 2 Code";
                                ReminderHeader.Modify;
                                ReminderLine.Insert();
                ...
                if ReminderHeader."Shortcut Dimension 1 Code" <> '' then begin
                    ReminderHeader."Course Reminder" := true;
                    ReminderHeader.Modify;
                end;
